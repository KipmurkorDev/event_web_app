      ...
      {isLoggedin ? (
        <>
          <ul className='flex gap-6 nav-link'>
            <li><NavLink to='/' activeClassName='active' hover:active>Home</NavLink></li>
            <li><NavLink to='/explore'>Explore Events</NavLink></li>
          ...
          <div className='inline-flex relative nav-link'>
            ...
            <input type="text" placeholder='Discover events' className='py-2 px-6 top-0 left-0 w-[20em] rounded-lg bg-zinc-300 bg-opacity-60 placeholder:text-neutral-500 placeholder:text-md' />
          </div>
          <div>
        ...
        <div>
          <Link to='/signup'><button className='nav-button'>Get Started</button></Link>
        </div>
      )}
    </nav>
  );
